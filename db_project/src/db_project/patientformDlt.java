...
public class patientformDlt {
	...
	public void initialize() {
		jf = new JFrame();
		jf.setTitle("Remove Patients data");
		...
		JLabel heading_lb = new JLabel("   REMOVE PATIENTS DATA");
		...
		removebtn.setBounds(577, 359, 140, 39);
		...
		removebtn.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae)
			{
				  if(pID_txt.getText().equals(""))
					...
					obj.PatientRemove(pID_txt.getText());
				}
			...
			{     if(pID_txt.getText().equals(""))
			 {
				...
				textField_discharge.setText(null);
		         ...
		         obj.PatientDLTSearch(pID_txt.getText());
			}
