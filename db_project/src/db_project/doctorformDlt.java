...
public class doctorformDlt {
	...
	public void initialize() {
		jf = new JFrame();
		jf.setTitle("Remove Doctor data");
		...
		JLabel heading_lb = new JLabel("   REMOVE DOCTOR DATA");
		...
		JLabel lbdoctorField = new JLabel("Doctor Field Specialization");
		lbdoctorField.setBounds(10, 259, 160, 15);
		lbdoctorField.setFont(new Font("Tahoma", Font.BOLD, 12));
		jf.getContentPane().add(lbdoctorField);
		
		typebox = new JComboBox<String>();
		typebox.setBounds(180, 256, 134, 22);
		...
		removebtn.setBounds(407, 315, 140, 39);
			...
			{     if(ID_txt.getText().equals(""))
			 {
				...
				obj.DocDLTSearch(ID_txt.getText());
			}
