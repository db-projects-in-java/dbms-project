...
public class RepformSearch {
	...
	public void initialize() {
		jf = new JFrame();
		jf.setTitle("Search Receptionist data");
		...
		JLabel heading_lb = new JLabel("    SEARCH RECEPTIONIST");
