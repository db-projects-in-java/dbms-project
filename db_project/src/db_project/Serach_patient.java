...
public class Serach_patient {
	...
	public void initialize() {
		jf = new JFrame();
		jf.setTitle("Search Patients data");
		...
		JLabel heading_lb = new JLabel("   SEARCH PATIENTS DATA");
		...
		pt_typebox.setBounds(107, 256, 123, 22);
			...
			{     if(pID_txt.getText().equals(""))
			 {
				...
				textField_discharge.setText(null);
		         ...
		         obj.PatientSearch(pID_txt.getText());
			}
