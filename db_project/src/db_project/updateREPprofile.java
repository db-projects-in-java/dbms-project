...
public class updateREPprofile {
	...
	public void initialize() {
		jf = new JFrame();
		jf.setTitle("Update Receptionist profile");
		...
		JLabel heading_lb = new JLabel("    UPDATE RECEPTIONIST PROFILE");
		...
		UpdateBTN.setBounds(540, 335, 179, 43);
		...
		JButton btnSearch = new JButton("VIEW");
		...
		UpdateBTN.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae)
			{
					...
					obj.RepUpdate(ID_txt.getText(),Rep_fname.getText(),Rep_lname.getText(),Integer.parseInt(age_txt.getText()),value2,value0,textField_address.getText(),textField_city.getText(),ph_no.getText(),value1,cnic_txt.getText(),textField_admit.getText(),value3);
