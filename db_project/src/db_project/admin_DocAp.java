...
public class admin_DocAp {
	...
	public void initialize() {
		...
		check1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae)
			{
				obj.setAppoinment_admin1(textField_1.getText());
			}
		});
		...
		check2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae)
			{
				obj.setAppoinment_admin2(textField_2.getText());
			}
		});
		setBtn.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae)
			{
				obj.setAppoinment1(textField_1.getText(),textField_2.getText(),Integer.parseInt(appno.getText()));
			}
		});
	}
}
