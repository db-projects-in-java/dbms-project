...
public class updateDOCprofile {
	...
	public void initialize() {
		jf = new JFrame();
		jf.setTitle("Update Doctor profile data");
		...
		JLabel heading_lb = new JLabel("   UPDATE DOCTOR PROFILE");
		...
		typebox.setModel(new DefaultComboBoxModel(new String[] {"A", "B", "C"}));
