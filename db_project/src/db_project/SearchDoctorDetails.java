...
public class SearchDoctorDetails {
	...
	public void initialize() {
		jf = new JFrame();
		jf.setTitle("Search Doctor data");
		...
		JLabel heading_lb = new JLabel("   SEARCH DOCTOR DATA");
