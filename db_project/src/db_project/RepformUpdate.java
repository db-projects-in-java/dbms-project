...
public class RepformUpdate {
	...
	public void initialize() {
		jf = new JFrame();
		jf.setTitle("Update Receptionist data");
		...
		JLabel heading_lb = new JLabel("    UPDATE RECEPTIONIST");
			...
			{     if(ID_txt.getText().equals(""))
			 {
				...
				obj.RepUpdateSearch(ID_txt.getText());
			}
